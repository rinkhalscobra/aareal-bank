  ...
  return (
    <div className="min-h-screen bg-[#F6F8F7]">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="bg-[#12355B] text-white py-20 px-8 lg:px-16 flex items-center">
          <div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 py-4 px-6">
        <div className="max-w-7xl mx-auto">
          <p className="text-[#24364B] text-sm font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold mb-4 text-[#172033]">
                {t.investments.bonus.title}
              </h2>
              <p className="text-[#3F4D5F] text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-[#3F4D5F] text-lg leading-relaxed mb-6">
                {t.investments.winterBonus.description}
              </p>
              <ul className="space-y-4 mb-6">
                <li className="text-[#3F4D5F] text-lg">
              ...
              <p className="text-[#5D6B7B] text-sm italic">
      ...
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-12 shadow-lg border-l-4 border-yellow-500">
            <h3 className="text-2xl font-bold mb-4 text-[#172033]">{t.investments.riskInfo.title}</h3>
            <p className="text-[#3F4D5F] text-lg leading-relaxed mb-4">
      ...
      <div className="bg-[#F6F8F7] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-12 text-[#172033]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              />
              <h3 className="text-2xl font-bold mb-4 text-[#172033]">{t.investments.whyInvest.tools.title}</h3>
              <p className="text-[#3F4D5F] text-lg leading-relaxed">
            ...
            <div className="bg-white p-8 shadow-lg hover:shadow-xl transition-shadow">
              <img
                ...
                className="w-20 h-20 mb-6"
              />
              <h3 className="text-2xl font-bold mb-4 text-[#172033]">{t.investments.whyInvest.beginnings.title}</h3>
              <p className="text-[#3F4D5F] text-lg leading-relaxed">
            ...
            <div className="bg-white p-8 shadow-lg hover:shadow-xl transition-shadow">
              <img
                ...
                className="w-20 h-20 mb-6"
              />
              <h3 className="text-2xl font-bold mb-4 text-[#172033]">{t.investments.whyInvest.investors.title}</h3>
              <p className="text-[#3F4D5F] text-lg leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white p-12 shadow-lg mb-16">
          ...
          <p className="text-[#5D6B7B] text-center mb-8">{t.investments.performance.disclaimer}</p>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-[#C7D3D0]">
                  <th className="text-left py-4 px-6 font-bold text-[#172033]">
                    {t.investments.performance.portfolioType}
                  </th>
                  <th className="text-center py-4 px-6 font-bold text-[#172033]">
              ...
              <tbody>
                {performanceData.map((data, index) => (
                  <tr key={index} className="border-b border-[#DDE7E3] hover:bg-[#F6F8F7]">
                    <td className="py-4 px-6 font-semibold text-[#172033]">{data.category}</td>
                    <td className="py-4 px-6 text-center text-green-600 font-bold">{data.return1Year}</td>
                    <td className="py-4 px-6 text-center text-green-600 font-bold">{data.return5Year}</td>
