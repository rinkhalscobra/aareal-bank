    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      <div className="bg-gradient-to-br from-[#000000] via-[#000000] to-[#000000] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-[#E5E5E5] max-w-3xl">{t.aboutUs.subtitle}</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
          <div className="bg-white p-10 shadow-lg">
            <h2 className="text-3xl font-bold mb-6 text-[#000000]">{t.aboutUs.mission.title}</h2>
            <p className="text-[#333333] text-lg leading-relaxed">{t.aboutUs.mission.description}</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#FFFFFF] via-[#E5E5E5] to-[#FFFFFF] p-12 shadow-lg text-[#000000] p-12 shadow-lg mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-[#FFFFFF] via-[#E5E5E5] to-[#FFFFFF] p-8 border-2 border-[#D00000] hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#D00000]">{t.aboutUs.principles.seamless.title}</h3>
              <p className="text-[#333333]">{t.aboutUs.principles.seamless.description}</p>
            </div>
            <div className="bg-gradient-to-br from-[#FFFFFF] via-[#E5E5E5] to-[#FFFFFF] p-8 border-2 border-[#D00000] hover:shadow-xl transition-all">
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-4">
                <path d="M12 10V14H24V10C24 6.6875 21.3125 4 18 4C14.6875 4 12 6.6875 12 10ZM10 14V10C10 5.625 13.5625 2 18 2C22.375 2 26 5.625 26 10V14H27C29.75 14 32 16.25 32 19V29C32 31.8125 29.75 34 27 34H9C6.1875 34 4 31.8125 4 29V19C4 16.25 6.1875 14 9 14H10ZM6 19V29C6 30.6875 7.3125 32 9 32H27C28.625 32 30 30.6875 30 29V19C30 17.375 28.625 16 27 16H9C7.3125 16 6 17.375 6 19Z" fill="#D00000"/>
              </svg>
              <h3 className="text-2xl font-bold mb-4 text-[#D00000]">{t.aboutUs.principles.secure.title}</h3>
              <p className="text-[#333333]">{t.aboutUs.principles.secure.description}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-12 shadow-lg">
          <div className="text-center">
            <Users className="w-16 h-16 text-[#D00000] mx-auto mb-6" />
