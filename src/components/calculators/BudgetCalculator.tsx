  ...
  return (
    <div className="bg-white p-8 shadow-lg">
      <div className="flex items-center gap-3 mb-6">
        <DollarSign className="w-8 h-8 text-[#D00000]" />
        <h3 className="text-2xl font-bold text-[#000000]">{t.financialEducation.calculators.budgetCalc.title}</h3>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-[#D00000] to-[#000000] text-white p-6 rounded-lg">
            ...
            <div className="space-y-3">
              ...
              <div className={`flex justify-between items-center pt-2 ${remaining >= 0 ? 'text-[#FFB3B3]' : 'text-[#D00000]'}`}>
          ...
          <div className="bg-[#F5F5F5] p-6 rounded-lg border-2 border-[#E5E5E5]">
            <h4 className="text-lg font-bold mb-4 text-[#000000]">{t.financialEducation.calculators.budgetCalc.ruleTitle}</h4>
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-semibold text-[#333333]">{t.financialEducation.calculators.budgetCalc.needs} ({needsPercent}%)</span>
                  <span className="text-sm text-[#555555]">{t.financialEducation.calculators.budgetCalc.target}: 50%</span>
                </div>
                <div className="w-full bg-[#E5E5E5] rounded-full h-4">
                  <div
                    className={`h-4 rounded-full ${Number(needsPercent) <= 50 ? 'bg-[#D00000]' : 'bg-[#D00000]'}`}
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-semibold text-[#333333]">{t.financialEducation.calculators.budgetCalc.wants} ({wantsPercent}%)</span>
                  <span className="text-sm text-[#555555]">{t.financialEducation.calculators.budgetCalc.target}: 30%</span>
                </div>
                <div className="w-full bg-[#E5E5E5] rounded-full h-4">
                  <div
                    className={`h-4 rounded-full ${Number(wantsPercent) <= 30 ? 'bg-[#D00000]' : 'bg-[#D00000]'}`}
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm font-semibold text-[#333333]">{t.financialEducation.calculators.budgetCalc.savings} ({savingsPercent}%)</span>
                  <span className="text-sm text-[#555555]">{t.financialEducation.calculators.budgetCalc.target}: 20%</span>
                </div>
                <div className="w-full bg-[#E5E5E5] rounded-full h-4">
                  <div
                    className={`h-4 rounded-full ${Number(savingsPercent) >= 20 ? 'bg-[#D00000]' : 'bg-[#D00000]'}`}
