...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#172033] text-white border-t-4 border-[#0F766E]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#C8942D]">
              {language === 'fr' ? 'Banque' : language === 'it' ? 'Servizi Bancari' : language === 'de' ? 'Banking' : language === 'es' ? 'Banca' : language === 'el' ? 'Τραπεζική' : 'Banking'}
            </h4>
            <ul className="space-y-2">
              <li>
                <Link to={getLangPath('/personal-banking')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <li>
                <Link to={getLangPath('/business-banking')} className="text-[#A7B1BC] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={getLangPath('/credit-cards')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <li>
                <Link to={getLangPath('/investments')} className="text-[#A7B1BC] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={getLangPath('/financial-education')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <li>
                <Link to={getLangPath('/rates')} className="text-[#A7B1BC] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={getLangPath('/about')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <li>
                <Link to={getLangPath('/who-we-serve')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <li>
                <Link to={getLangPath('/support')} className="text-[#A7B1BC] hover:text-white transition-colors">
        ...
        <div className="border-t border-[#24476F] pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-[#A7B1BC] text-sm">
              © 2026 Aareal Bank AG. {t.footer.rights}
            </p>
            <div className="flex flex-wrap justify-center md:justify-end gap-4 text-sm">
              <Link to={getLangPath('/terms-of-service')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <span className="text-[#5D6B7B]">|</span>
              <Link to={getLangPath('/privacy-policy')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <span className="text-[#5D6B7B]">|</span>
              <Link to={getLangPath('/risk-disclosure')} className="text-[#A7B1BC] hover:text-white transition-colors">
              ...
              <span className="text-[#5D6B7B]">|</span>
              <Link to={getLangPath('/refund-policy')} className="text-[#A7B1BC] hover:text-white transition-colors">
