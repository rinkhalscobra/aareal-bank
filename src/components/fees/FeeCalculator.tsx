  ...
  return (
    <div className="bg-white  shadow-lg p-8">
      <div className="flex items-center mb-6">
        <Calculator className="w-8 h-8 text-[#D00000] mr-3" />
        <h3 className="text-2xl font-bold text-[#000000]">{t.rates.calculator.title}</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-[#CCCCCC]  focus:ring-2 focus:ring-[#D00000] focus:border-transparent"
            >
          ...
          <div>
            ...
            <div className="relative">
              <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#CCCCCC]" />
              <input
                type="number"
                value={monthlyBalance}
                onChange={(e) => setMonthlyBalance(e.target.value)}
                className="w-full pl-10 pr-4 py-3 border border-[#CCCCCC]  focus:ring-2 focus:ring-[#D00000] focus:border-transparent"
                placeholder="1000"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="4"
            />
            <p className="text-xs text-[#777777] mt-1">{t.rates.calculator.firstFree}</p>
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-5 h-5 text-[#D00000] border-[#CCCCCC] focus:ring-[#D00000]"
            />
            <label htmlFor="paperStatements" className="ml-3 text-sm font-medium text-[#000000]">
        ...
        <div>
          <div className="bg-gradient-to-br from-[#D00000] to-[#000000] text-white  p-8 mb-6">
            ...
            <div className="border-t border-[#D00000] pt-6">
          ...
          {breakdown.length > 0 ? (
            <div className="bg-[#F5F5F5]  p-6">
              <h4 className="font-bold text-[#000000] mb-4">{t.rates.calculator.feeBreakdown}</h4>
              <div className="space-y-3">
                {breakdown.map((item, index) => (
                  <div key={index} className="flex justify-between items-center">
                    <span className="text-sm text-[#333333]">{item.item}</span>
            ...
            <div className="bg-[#FFF1F1] border border-[#F5C2C7]  p-6">
          ...
          <div className="mt-6 p-4 bg-[#FFF1F1] border border-[#F5C2C7] ">
